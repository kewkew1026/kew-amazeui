...
<div class="am-datepicker">
  ...
  <div class="am-datepicker-date" v-if="showDatePicker" v-show="show.date">
    <date-picker :selected-date.sync="dateTime"></date-picker>
  </div>
  <div class="am-datepicker-time" v-if="showTimePicker" v-show="show.time">
    <time-picker :selected-date.sync="dateTime" :viewchange="handleViewChange"></time-picker>
  </div>
  <div class="am-datepicker-toggle" v-if="showDatePicker&&showTimePicker" v-show="show.date" :click="handleToggleTime">
    <icon name="clock-o"></icon>
  </div>
  <div class="am-datepicker-toggle" v-if="showDatePicker&&showTimePicker" v-show="show.time" :click="handleToggleDate">
