...
<grid>
  ...
  <column :sm="3">
    <date-time-picker :date-time.sync="myDate1"></date-time-picker>
  </column>
  <column :sm="3">
    <date-time-picker :date-time.sync="myDate1" :show-time-picker="false"></date-time-picker>
  </column>
  <column :sm="3">
    <date-time-picker :date-time.sync="myDate1" :show-date-picker="false"></date-time-picker>
  </column>
  <column :sm="3">
    <date-time-input :date-time.sync="myDate2"></date-time-input>
  </column>
  <column :sm="3">
    <date-time-input :date-time.sync="myDate2" date-only></date-time-input>
  </column>
  <column :sm="3">
    <date-time-input :date-time.sync="myDate2" time-only></date-time-input>
  </column>
</grid>
